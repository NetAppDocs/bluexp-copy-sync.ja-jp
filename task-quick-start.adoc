...
Cloud Managerを使い始めておきます。これには、ログイン、アカウントのセットアップ、場合によってはコネクタの導入、作業環境の作成が含まれます。
...
[role="quick-margin-para"]
Cloud Volumes ONTAP クラスタとオンプレミスのONTAP クラスタにはコネクタが必要です。

* https://docs.netapp.com/us-en/cloud-manager-setup-admin/concept-overview.html["Cloud Managerの利用を開始する方法をご確認ください"^]
