...
+
--
この設定は、同期関係を作成する場合、およびS3バケットまたはGoogle Cloud StorageからAzure Blob Storage、CIFS、Google Cloud Storage、IBM Cloud Object Storage、NFS、S3、StorageGRID のいずれかのターゲットにデータを同期する場合にのみ使用できます。
